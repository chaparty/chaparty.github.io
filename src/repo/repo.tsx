...
export default class Repository {
  ...
  requestBody() {
    return `"operationName":"withSearchResults","variables":{"query":"*","queryParams":{"queryParamItems":[{"name":"anchor","values":"profile"},{"name":"asc","values":"u"}],"pageSize":100,"artistUserName":"chaparty"},"locale":"en","country":"GB","currency":"GBP","previewTypeIds":["product_close","alternate_product_close","artwork"],"experience":"artists-own-shop"},
    query withSearchResults(
      $query: String!
